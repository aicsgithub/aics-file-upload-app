...
export const SET_DEFERRED_ACTIONS = makeConstant(BRANCH_NAME, "set-deferred-actions");
export const CLEAR_DEFERRED_ACTIONS = makeConstant(BRANCH_NAME, "clear-deferred-actions");
