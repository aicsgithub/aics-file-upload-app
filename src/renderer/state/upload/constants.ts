...
export const CANCEL_UPLOAD_SUCCEEDED = makeConstant(BRANCH_NAME, "cancel-upload-succeeded");
export const CANCEL_UPLOAD_FAILED = makeConstant(BRANCH_NAME, "cancel-upload-failed");
...
export const RETRY_UPLOAD_SUCCEEDED = makeConstant(BRANCH_NAME, "retry-upload-succeeded");
export const RETRY_UPLOAD_FAILED = makeConstant(BRANCH_NAME, "retry-upload-failed");
