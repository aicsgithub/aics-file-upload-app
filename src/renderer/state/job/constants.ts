...
export const GATHER_STORED_INCOMPLETE_JOB_IDS = makeConstant(BRANCH_NAME, "gather-stored-incomplete-jobs");
export const UPDATE_INCOMPLETE_JOB_IDS = makeConstant(BRANCH_NAME, "update-incomplete-jobs");
