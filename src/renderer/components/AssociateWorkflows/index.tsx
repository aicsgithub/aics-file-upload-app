...
// import { AssociateFilesAndWorkflowsAction } from "../../state/upload/types";
...
//     const selectedWorkflowNames: string[] = selectedWorkflows.map(
//       (workflow: Workflow) => workflow.name
//     );
//     const associationsTitle = `Selected Workflows: ${selectedWorkflowNames
//       .sort()
//       .join()}`;
...
//               ({ description, name, workflowId }: Workflow) => (
//                 <Tabs.TabPane key={`${workflowId}`} tab={name}>
//                   <KeyValueDisplay
...
//     const workflows = this.props.workflowOptions.filter((workflow) =>
...
//     return (
//       this.props.selectedWorkflows.length > 0 &&
//       this.props.selectedFiles.length > 0
//     );
//   };

//   private associate = (): void => {
//     this.props.associateFilesAndWorkflows(
