...
class SaveUploadDraftModal extends React.Component<
  SaveUploadDraftModalProps,
  SaveUploadDraftModalState
> {
  ...
  public render(): ReactNode {
    const { canSaveUploadDraft, className, usedNames, visible } = this.props;
    return (
      <Modal
        className={className}
        okButtonProps={{
